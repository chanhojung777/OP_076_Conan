...
class SteerLimitParams:
  STEER_MAX = 1000   # 409 is the max, 255 is stock
  STEER_DELTA_UP = 4
  STEER_DELTA_DOWN = 7
...
FEATURES = {
  ...
  "use_elect_gears": [CAR.KIA_OPTIMA_H, CAR.KONA_EV, CAR.GRANDEUR_H_19, CAR.GRANDEUR_H_20, CAR.IONIQ_HEV, CAR.IONIQ_EV], # Use TCU Message for Gear Selection
}

EV_HYBRID = [CAR.KONA_EV,CAR.GRANDEUR_H_19, CAR.GRANDEUR_H_20, CAR.IONIQ_HEV, CAR.IONIQ_EV]
